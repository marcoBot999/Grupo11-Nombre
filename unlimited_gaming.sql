...
--
-- Host: 127.0.0.1    Database: unlimiited_gaming
-- ------------------------------------------------------
...
CREATE TABLE `products` (
  ...
  `price` int NOT NULL,
  `id_product_categorry` int NOT NULL,
...
CREATE TABLE `type_user` (
  ...
  `type_ name` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2022-10-28 10:45:06
